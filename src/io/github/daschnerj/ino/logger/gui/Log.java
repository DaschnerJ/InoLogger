 ...
 */
package io.github.daschnerj.ino.logger.gui;
...
public class Log {
     ...
     */
    public Log(String name, String location, String extension) {
    ...
    public Log(String name, Boolean exitCode, String extension)
    {
        this.location = f.GetExecutionPath() +"\\logs\\";
        this.name = name;
        this.exitCode = exitCode;
    ...
    public Log(String name, String location, String extension, Boolean exitCode)
    {
        this.location = location;
        this.name = name;
        this.exitCode = exitCode;
     ...
     * @param obj The value to be inputed into the entry.
     */
    ...
    private void createLog() {
        System.setProperty("java.util.logging.SimpleFormatter.format", 
            "[%1$tY-%1$tm-%1$td] %1$tH:%1$tM:%1$tS %4$-8s: %5$s\n");
        FileHandler fh;
    ...
    public void logTo(String msg, JTextPane j)
    {
        this.addInfo(msg);
        updateLog(j);
    }
    
    public void updateLog(JTextPane j)
    {
        j.setText(getConsole().getText());
    }
}
